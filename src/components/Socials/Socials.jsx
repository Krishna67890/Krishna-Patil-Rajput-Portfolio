...
const Socials = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Blogger', url: 'https://krishnablogy.blogspot.com/', icon: '📝', isImg: false, desc: "Read my latest tech articles on my Blog." },
    { name: 'YouTube', url: 'https://www.youtube.com/@atharva_gaming_yt', icon: '📺', isImg: false, desc: "Watch my coding and gaming content on YouTube." },
